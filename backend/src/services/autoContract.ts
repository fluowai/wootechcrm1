        ...
        if (!existingInvoice) {
          ...
          await this.prisma.invoice.create({
            data: {
              ...
              subtotal: Number(contract.soldProduct.setupValue || 0) + Number(contract.soldProduct.monthlyValue || 0),
              total: Number(contract.soldProduct.setupValue || 0) + Number(contract.soldProduct.monthlyValue || 0),
